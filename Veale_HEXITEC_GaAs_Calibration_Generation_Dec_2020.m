...
noise_multiplier = 7; %4 for CdTe @ 500V
...
Peak_Amp = zeros(80,80,3);
Peak_Cent = zeros(80,80,3);
Rsq = zeros(80,80);
Max_Amp = zeros(80,80);
...
E_Peak(:,1) = [59.54 13.94 17.75];
E_window = 3; %keV
Peak_Window_Low = zeros(3,1);
Peak_Window_High = zeros(3,1);
